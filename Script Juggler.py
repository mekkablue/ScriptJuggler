...
INSET = 8
MIN_TITLE_WIDTH = 80
MIN_WINDOW_WIDTH = DRAG_COL_WIDTH + DONE_COL_WIDTH + MIN_TITLE_WIDTH + PLAY_COL_WIDTH + SCROLLBAR_WIDTH + 120
MIN_WINDOW_HEIGHT = ROW_HEIGHT * 2 + ROW_HEIGHT // 2 + BOTTOM_BAR_HEIGHT + 22 + int(ROW_HEIGHT * 1.5)
